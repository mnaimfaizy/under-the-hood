...
>
  ...
  {#if mode === "kid"}
    ...
    <g role="group" aria-label="Magic Cloud - handles special tasks like timers">
      ...
      <!-- Cloud shape overlay -->
      <path
        d="M 750 80 Q 730 70 750 80 Q 770 70 790 80 Q 810 70 790 80 Q 810 110 790 130 Q 770 140 750 130 Q 730 140 750 130 Q 730 110 750 80 Z"
        fill="#bfdbfe"
        stroke="#3b82f6"
        stroke-width="2"
      />
      ...
      <!-- Lightning bolts -->
      <path
        d="M 780 85 L 785 90 L 783 90 L 788 95 L 786 95 L 791 100"
        stroke="#fbbf24"
        stroke-width="2"
        fill="none"
      />
      <path
        d="M 820 85 L 825 90 L 823 90 L 828 95 L 826 95 L 831 100"
        stroke="#fbbf24"
        stroke-width="2"
        fill="none"
      />
    ...
    <g role="group" aria-label="Speedy Lane - quick tasks like promises">
      ...
      <!-- Speed signs -->
      <polygon
        points="80,365 90,355 100,365 90,375"
        fill="#ef4444"
        stroke="#dc2626"
        stroke-width="2"
      />
      <text x="90" y="372" text-anchor="middle" fill="white" font-size="12" font-weight="bold"
        >!</text
      >
      <polygon
        points="200,365 210,355 220,365 210,375"
        fill="#ef4444"
        stroke="#dc2626"
        stroke-width="2"
      />
      <text x="210" y="372" text-anchor="middle" fill="white" font-size="12" font-weight="bold"
        >!</text
      >
      <!-- Race car -->
    ...
    <g role="group" aria-label="Waiting Line - regular tasks like timers">
      ...
      <!-- Queue arrows -->
      <path
        d="M 550 380 L 570 380 L 565 375 M 570 380 L 565 385"
        stroke="#ef4444"
        stroke-width="2"
        fill="none"
      />
      <text x="500" y="445" text-anchor="middle" class="fill-black" font-size="14"
        >Waiting Line</text
      >
    </g>
    ...
    <g role="group" aria-label="Magic Conveyor - moves tasks around">
      ...
      <text x="800" y="445" text-anchor="middle" class="fill-black" font-size="14"
        >Magic Conveyor</text
      >
    </g>
  {:else}
