...
<svg {width} {height} viewBox={`0 0 ${width} ${height}`} class="w-full h-auto" role="img" aria-label={mode === 'pro' ? 'JavaScript runtime and engine stage' : 'JavaScript runtime playground stage'}>
  <!-- Grid background -->
  <defs>
